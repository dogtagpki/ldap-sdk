...
public class LDAPSchema implements Serializable {
    ...
    private void add( LDAPSchemaElement el,
        ...
        if ( el instanceof LDAPAttributeSchema ) {
            ...
            _matchingRules.put( name, (LDAPMatchingRuleSchema) el );
    ...
    public LDAPDITContentRuleSchema getDITContentRuleSchema( String name ) {
        return _contentRules.get( name.toLowerCase() );
    }
     ...
     */
    public Enumeration<LDAPDITContentRuleSchema> getDITContentRuleSchemas() {
    ...
    public LDAPMatchingRuleSchema getMatchingRuleSchema( String name ) {
        return _matchingRules.get( name.toLowerCase() );
    }
     ...
     */
    public Enumeration<LDAPMatchingRuleSchema> getMatchingRuleSchemas() {
     ...
     */
    public Enumeration<String> getMatchingRuleUseNames() {
    ...
    public LDAPMatchingRuleUseSchema getMatchingRuleUseSchema( String name ) {
        return _matchingRuleUses.get( name.toLowerCase() );
    }
     ...
     */
    public Enumeration<LDAPMatchingRuleUseSchema> getMatchingRuleUseSchemas() {
    ...
    public String toString() {
        ...
        s += "Matching rules:\n";
        Enumeration<LDAPMatchingRuleSchema> en3 = getMatchingRuleSchemas();
